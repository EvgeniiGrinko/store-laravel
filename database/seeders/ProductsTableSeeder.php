...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            ['name'=> 'Samsung A71', 'code' => 'samsung_a71', 'description' => 'Smart and perfect for a reasonable price', 'image' => 'products/samsung_a71.jpeg', 'price' => '49900', 'category_id' => 1, 'hit' => 1, 'new' => 0, 'recommended' => 0,'count' => rand(0,20)],
            ...
            ['name'=> 'Samsung EarBuds 3', 'code' => 'samsung_earbuds3', 'description' => 'The most pure sound easily connected your phone and your heart through ears', 'image' => 'products/samsung_earbuds3.webp', 'price' => '17990', 'category_id' => 2, 'hit' => 0, 'new' => 1, 'recommended' => 1,'count' => rand(0,20)],
