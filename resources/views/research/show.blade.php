                        ...
                        <ol>
                            ...
                            <ul class="">
                                @foreach($question->questionOptions as $questionOption)
                                    <li class="list-inline"><input type=checkbox  name="{{$questionOption->option_description}}" id="{{$questionOption->id}}" value={{$questionOption->value}}>{{$questionOption->option_description}} </li>
                                @endforeach
                            </ul>
                        </ol>
                        <?php echo '<script>
